  ...
  return (
    <>
      <div className="antialiased bg-hero bg-no-repeat bg-cover">
            ...
            <div> 
              <div className="relative">
                <div className="bg-white bg-opacity-50 rounded-xl p-8 text-gray-800 md:w-full">
                  <form action="https://formspree.io/f/mpzebnra" method="POST" className="flex flex-col space-y-6">
                    <div>
                      <label
                        htmlFor=""
        ...
        <div className="flex flex-col items-center justify-center p-8 rounded-xl shadow-lg " id="maps">
        <iframe
